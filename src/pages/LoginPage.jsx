...
export default function LoginPage(onLogin) {
  ...
  <div className="login-title">Lumé</div>
  <div className="login-subtitle">Where every thought becomes a tale</div>
  <div className="login-divider"></div>
  <div className="login-card">
    <h2>Begin your story</h2>
    <button className="oauth-btn" id="btn-google">
    ...
    <button className="demo-btn" onClick={onLogin}>✨ Enter as Guest</button>
    <div className="login-footer">By continuing, you agree to Lumé's<br/>Terms of Service &amp; Privacy Policy</div>
  </div>
</div>
</>
    )
